...
import jgroove.json.JsonFav;
import jgroove.json.JsonGetSong;
import jgroove.json.JsonPlaylist;
import jgroove.json.JsonPlaylistSongs;
import jgroove.json.JsonSearchResults;
import jgroove.json.JsonSongs;
import jgroove.json.JsonUser;
import jgroove.JGroove;

/**
 * Abstract class with easy and quick methods to communicate with Grooveshark
 */
public class JGroovex {
	...
	public static JsonSearchResults getSearchResults(String query, String type) throws IOException {
		...
		String response = JGroove.callMethod(parameters, "getResultsFromSearch"); //"getSearchResultsEx"  getResultsFromSearch
